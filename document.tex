...
\begin{frame}{\insertsection: \insertsubsection}
	\begin{minipage}{.45\textwidth}
		...
		\note<3>{
			Terrain		
			\begin{itemize}
				\item genaue Vermessung der Erde
		...
		\note<4>{
			...
			\begin{itemize}
				...
				\item Interpolation aktueller Entwicklung
			\end{itemize}
		}
		\note<5>{
			Andere		
			\begin{itemize}
				\item Internet und Telephon eher Nische
				\item mit besserer Technologie
